...
thumbSize = ((Screen.width-3.5*padding-back.width)/3)*1.4
...
bucketThumbnailsContainer.backgroundColor = "rgba(255,255,255,0)"
...
for bucketObject, index in data.buckets
	...
	bucketBox.states.default =
				...
				x: xPosition
				y: yPosition
				backgroundColor: bucketObject.backgroundColor
				animationOptions: 
					curve: Bezier.ease
					time: 0.1
	bucketBox.state = "default"			
	...
	bucketBoxThumb.backgroundColor = bucketObject.backgroundColor
